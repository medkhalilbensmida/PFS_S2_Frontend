...
import { SessionListComponent } from './courses/components/session-list/session-list.component';
import { AppCourseDetailComponent } from './courses/components/session-detail/course-detail.component';
